...
//Sandhaufen & Weg================================
 height_field{tga "sandhaufen_hf.tga" smooth scale <35,4,12> translate <25,0,-34> pigment{image_map { jpeg "sand_schnee.jpg" map_type 0 interpolate 2} rotate x*90}}
 height_field{png "Mount2.png" smooth scale <18,6,24> rotate y*17 translate <42,-0.2,-42> pigment{image_map { jpeg "sand_schnee.jpg" map_type 0 interpolate 2} rotate x*90}}
height_field{png "kegel_grauschwarz.png" smooth scale <18,6,34> rotate y*23 translate <70,-0.2,-104> pigment{image_map { jpeg "kies_grob_schnee.jpg" map_type 0 interpolate 2} rotate x*90 scale <8,1,5>}}
//Kleinkram
...
//Bodenplatte
object {bodenplatte texture { pigment{ image_map {  png "Boden-Erde-Steine_schnee2.png" map_type 0 interpolate 2}} rotate <90,0,0> scale 25 finish {ambient 0}}}
