...
#declare LAUB = texture {
	pigment {
		...
		omega 0.0
		pigment_map {
			[0.0 color rgbf< .77,.38,.06, 0.4>*.85]
			[1  color rgbf< .4,.11,.11,.3>*.8]
		}
		scale 597.0447
	}
	finish {
...
//Bodenplatte
object {bodenplatte texture { pigment{ image_map { jpeg "grasstexschnee.jpg" map_type 0 interpolate 2}} rotate x*90 scale 15 finish {ambient 0}}}
