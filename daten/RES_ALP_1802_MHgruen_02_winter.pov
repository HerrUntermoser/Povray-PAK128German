...
#declare WandPutz = texture{pigment{bozo turbulence 1 frequency 15 color_map{
                                   [0 color rgb <.7,.78,.6>*.9]
                                    [0.5 color rgb <.7,.78,.6>*.2]
                                    [1 color rgb <.7,.78,.6>*.8]
                                   /* [0 color rgb <.80,.57,.35>*.7]
                                    [0.5 color rgb <.80,.57,.35>*1]
                                    [1 color rgb <.80,.57,.35>*.2]*/
                                    }
                                    scale <2,.5,1>}
...
//=======================================================
#declare dach = prism{0,40,4, <0,0>,<15,12>,<0,24>,<0,0> texture{pigment{image_map{jpeg "dachziegel_alt_schnee.jpg" interpolate 2}}scale 15}}
...
box{<0,0,0>,<7.5,.1,8> translate<-.25,7.05,-.1> texture{T_Chrome_1A}}
...
//Bodenplatte
object {bodenplatte texture{pigment{ image_map { jpeg "grasstex_schnee.jpg" interpolate 2}  scale 40 rotate x*90}}}
//Ende Bodenplatte
