...
#include "basis.inc"
/*
#declare CAM_X = vaxis_rotate ( x, y, -45);
#declare CAM_Y = vaxis_rotate ( y, y, -45);
#declare CAM_Z = vaxis_rotate ( z, y, -45);

#declare CAM_X = vaxis_rotate (CAM_X, CAM_X, degrees (asin(0.5)));
#declare CAM_Y = vaxis_rotate (CAM_Y, CAM_X, degrees (asin(0.5)));
#declare CAM_Z = vaxis_rotate (CAM_Z, CAM_X, degrees (asin(0.5)));

#declare L = sqrt (8);

  location  CAM_Z * -10000 + CAM_X * L * 8 + CAM_Y * L * 8
  right CAM_X * image_width
  up CAM_Y * image_height
  direction CAM_Z
  */
...
//box {<-10,0,24.49>,<65,60,24.51> pigment {checker color rgb 0 color rgb 1 scale 2}}                 
//Abzug Dachflaechen
...
//Ziersockel 2.
box {<-0.2,37,-0.2>,<70.2,37.7,50.2> texture {pigment{color rgb <0.89,0.85,0.65>*0.6} normal {bumps 0.3 scale 0.08}}}
...
object {Balkon translate <50,20,-50> pigment {color rgb 1}}
//Fenster EG
...
//Fenster DG
object {Fenster5x8_5_L translate <52.75,38,-100>}
//Fenster EG-R
object {Fenster5x8_5_L rotate <0,180,0> translate <35,4,-50.2>}
object {Fenster5x8_5_L rotate <0,180,0> translate <80,4,-50.2>}
//Fenster 1. R
object {Fenster5x8_5_L rotate <0,180,0> translate <35,22,-50.2>}
object {Fenster5x8_5_L rotate <0,180,0>translate <80,22,-50.2>}
//Fenster DG-R
object {Fenster5x8_5_L rotate <0,180,0> translate <57.75,38,-50.2>}
//Fenster EG-links
...
//Fenster DG-links
object {Fenster5x8_5_L rotate <0,90,0> translate <20,38,-83>}
object {Fenster5x8_5_L rotate <0,90,0> translate <20,38,-62>}
...
//Fenster DG-rechts
object {Fenster5x8_5_L rotate <0,-90,0> translate <90,38,-88>}
object {Fenster5x8_5_L rotate <0,-90,0> translate <90,38,-67>}
//Haustür
union{
difference{
...
union{
difference {
box {<0,0,0.2>,<5,10,0.3>}
box {<0.2,0.2,0.1>,<2.4,9.8,0.4>}
box {<2.6,0.2,0.1>,<4.8,9.8,0.4>}
}
box {<0,0,0.2>,<5,10,0.25> texture{Green_Glass}}
texture{T_Wood22 scale 0.8}
translate <52.5,20,-51.8>}
...
#while (ZV <= endZV)
union {
object{Dachziegelengobiert (20) rotate y*90 rotate z*-55 translate <39,44.5,ZV> texture{pigment{gradient y color_map {[0.0 color rgb 0.3*0.7]
                                                                                                [0.9 color rgb 0.3*0.5]
                                                                                                [0.9 color rgb 0.1]
                                                                                                [1 color rgb 0]
                                                                                                }
...
#while (ZV <= endZV)
object{Dachziegelengobiert (20) rotate y*90 rotate z*55 translate <71.5,44.5,ZV> texture{pigment{gradient y color_map {[0.0 color rgb 0.3*0.7]
                                                                                                [0.9 color 0.3*0.5]
                                                                                                [0.9 color rgb 0.1]
                                                                                                [1 color rgb 0]
                                                                                                }
...
//Mauer
/*union{
box { <-20,0,-134>,<-19,2,-15>}
box { <10,0,-134>,<100,2,-133>}
box { <99,0,-134>,<100,2,-15>}
box { <-20,0,-14>,<100,2,-15>}
texture{T_Stone25 scale 0.5}}*/
...
/*cylinder {<0,0,-15.3>,<0,0,-133>,0.15 texture {T_Chrome_1A} translate <-19,5,0>}
cylinder {<0,0,-15.3>,<0,0,-133>,0.15 texture {T_Chrome_1A} translate <-19,3,0>}
cylinder {<0,0,-15.3>,<0,0,-133>,0.15 texture {T_Chrome_1A} translate <99,5,0>}
cylinder {<0,0,-15.3>,<0,0,-133>,0.15 texture {T_Chrome_1A} translate <99,3,0>}
cylinder {<-19.6,0,>,<99.6,0,>,0.15 texture {T_Chrome_1A} translate <0,5,-15.3>}
cylinder {<-19.6,0,>,<99.6,0,>,0.15 texture {T_Chrome_1A} translate <0,3,-15.3>}
cylinder {<9.6,0,>,<99.6,0,>,0.15 texture {T_Chrome_1A} translate <0,5,-133.6>}
cylinder {<9.6,0,>,<99.6,0,>,0.15 texture {T_Chrome_1A} translate <0,3,-133.6>}
*/
#declare zLstart = -132;
#declare zLende = -15;
...
box {<-19,-0.1,-14>,<99,0.05,-60>texture{ pigment{bozo turbulence 0.3 color_map{[0.0 color rgb 1*0.2]
                                                                [0.5 color rgb .9*1]
                                                                [1 color rgb 1]
                                                                } }
                 normal { bozo 3 scale 0.05}
...
//object {bodenplatte texture { pigment{ image_map { png "schnee_ground.png" map_type 0 interpolate 2}} rotate <90,0,0> scale 5 finish {ambient 0}}}
//Ende Bodenplatte
//schnee
/*difference {
union{
object {schnee scale <70,6,35> rotate <-38,0,0> translate <20,39.2,-102>}
object {schnee scale <70,6,35> rotate <38,0,0> translate <20,60,-75> }
}
box {<43,35,-103>,<66,50,-80>}
box {<43,35,-60>,<66,50,47>}
}*/
#declare Richtung = 0;
#switch ( Richtung )
