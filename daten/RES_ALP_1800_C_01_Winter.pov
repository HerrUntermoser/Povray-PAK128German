...
#declare Ziegeltextur_r = texture{pigment{gradient x 
           color_map{[0.00 color rgb 0.9*0.9 ]
                     [0.90 color rgb 0.8*0.7 ]
                     [0.90 color rgb 0.8]
                     [0.95 color rgb 0.9]
                     [1.00 color rgb 0.9]}
                    scale 2 }}
#declare Ziegeltextur_l = texture{pigment{gradient x 
           color_map{[0.00 color rgb 0.71*1.4 ]
                     [0.90 color rgb 0.71*1.4 ]
                     [0.90 color rgb 0.71*1.1]
                     [0.95 color rgb 0.71*1.1]
                     [0.95 color rgb 0]
                     [1.00 color rgb 0]}
                    scale 3 }}
...
#declare startx = 53;
 ...
 #include "eiche.inc"
 #declare Rinde = 
 texture{ pigment{ color rgb 0.6*1.2 } 
...
//Bodenplatte
object {bodenplatte texture{pigment{image_map{jpeg "grasstex1_schnee.jpg" map_type 0 interpolate 2}} rotate x*90 scale 50}}
