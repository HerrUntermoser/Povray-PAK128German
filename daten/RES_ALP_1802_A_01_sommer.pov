...
#declare TOP_COLOR_2=<0.32, 0.41,0,0,0>;
...
#declare BOZO1 = pigment {
	bozo
	color_map {
		[0 color rgb<0.29, 0.33, 0.13>*1.2]
		[1 color rgb<0.29, 0.33, .13>*0.5]
	}
	scale 0.04
}
#declare BOZO2 = pigment {
	bozo
	color_map {
		[0 color rgb<.48,.71, .38>*.1]
		[1 color rgb<.48,.71,.38>*.6]
	}
	scale 0.04
}
...
union {object{FOLIAGE}object{WOOD}double_illuminate hollow scale 25 translate <70,0,-120>}
union {object{FOLIAGE}object{WOOD}double_illuminate hollow scale 25 rotate y*85 translate <75,0,-100>}
union {object{FOLIAGE}object{WOOD}double_illuminate hollow scale 25 rotate y*-32 translate <84,0,-90>}
...
union {object { sassafras_13_stems texture{ Stem_Texture }} object { sassafras_13_leaves double_illuminate texture{ Leaves_Texture_1 } interior_texture{ Leaves_Texture_2 }} translate<-10,0,-90>}
