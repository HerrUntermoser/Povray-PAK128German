...
//Dachtextur
#declare Dachtextur = texture{pigment{image_map{ tga "Sonny_Block_Dach_schnee.tga" map_type 0 interpolate 2}}}
...
#declare Zaunpfosten = union{box{<0,0,0>,<1,5,1>}box{<-0.2,5,-0.2>,<1.2,5.2,1.2>}texture{pigment{color rgb 0.8} normal{granite 1 scale 1}}}
...
pigment
 {granite
  turbulence 0.0
  color_map
   {[0.0, 0.07 color rgb <.40,.26,.13> color Brown]
    [0.07, 0.2 color White color White]
    [0.2, 0.3 color rgb 0.7 color Clear]
    [0.3, 0.7 color Clear color Clear]
    [0.7, 1.0 color Brown color rgb 0.7]
   }
   }finish {crand 0.02}}
...
interior{ media{ method 3
           emission <1,1,1>*0.4
           scattering{ 4, // Type 1 = isotropic scattering, 2 = Mie haze, 3 = Mie murky
                          // Type 4 = Rayleigh scattering,  5 = Henyey-Greenstein scattering
                       <1,1,1>*2.00   // color of scattering haze
                       extinction  .9  //  // 0 ~ 1 extinction
                       }
           ...
           density{ spherical // or: boxed
                    ...
                    turbulence 0.95
                    color_map {
                    [0.00 rgbt <0,0,0,0.7>] // density at the border of the media
                    [0.05 rgbt <0,0,0,0.7>]
                    [0.20 rgbt <0.2,0.2,0.2,0.85>]
                    [0.30 rgbt <0.6,0.6,0.6,0.95>]
                    [0.40 rgbt <1,1,1,0.95>]
                    [1.00 rgbt <1,1,1,0.95>] // densitiy at the center of the media
                               } // end color_map
           } // end of density
...
//summer
#declare blaetter1 = 
 texture{ pigment{ color rgbf< 0.8, 0.8, 0.8, 0.8>*0.75 }   
          normal { bumps 0.15 scale 0.05 }
          finish { phong 1 reflection 0.00}
        } // end of texture 
//-------------------------------------------------------- 
#declare blaetter_2 = 
 texture{ pigment{ color rgbf< 0.8, 0.8, 0.8, 0.8>*0.25 }   
          normal { bumps 0.15 scale 0.05 }
...
#declare LEAVES=2*BUNCHES;
#declare BOTTOM_COLOR_1=<1,1,1,0,0>;
#declare BOTTOM_COLOR_2=<0.7,0.7,0.7,0,0>;
#declare TOP_COLOR_1=<0.7, 0.7,.7,0,0>;
#declare TOP_COLOR_2=<0.8, 0.8,.8,0,0>;
...
#declare BOTTOM_COLOR_1=<.9,.9,.9,0,0>;
#declare BOTTOM_COLOR_2=<.9,.9,.9,0,0>;
#declare TOP_COLOR_1=<1, 1,1,0,0>;
#declare TOP_COLOR_2=<1,1,1,0,0>;
#declare RAISED_TRUNK_COLOR=<.9,.9,.9>*.3;
...
#declare RINDE1 = texture {
	pigment {
		...
		cubic_wave
		color_map {
			[0 color rgb <0.5, 0.5, 0.7>]
			[0.35 color rgb <0.0, 1.2, 0.0>]
			[0.50 color rgb <0.0, 1.2, 0.0>]
			[0.65 color rgb <0.0, 1.2, 0.0>]
...
object{WOOD scale 25 translate <70,0,-120>}
union {object{FOLIAGE}object{WOOD}double_illuminate hollow scale 25 rotate y*85 translate <75,0,-100>}
object{WOOD double_illuminate hollow scale 25 rotate y*-32 translate <84,0,-90>}

//Bäume hinter dem Haus
//Sassafras
#declare Stem_Texture = 
 texture{ pigment{ color rgb<.5,.5,.5>} 
          normal { bumps 0.75 scale <0.025,0.075,0.025> }
          finish { phong 0.2 reflection 0.00}         
        }
#declare Leaves_Texture_1 = 
 texture{ pigment{ color rgbf< 1, 1, 0.9, 0.1>*0.75 }   
          normal { bumps 0.15 scale 0.05 }
          finish { phong 1 reflection 0.00}
        }
#declare Leaves_Texture_2 = 
 texture{ pigment{ color rgbf< 1, 1, 1, 0.2>*0.25 }   
          normal { bumps 0.15 scale 0.05 }
          finish { phong 0.2 reflection 0.00}
        }
#include "sassafras_m.inc"
object { sassafras_13_stems texture{ Stem_Texture}  translate<-10,0,-90>}
union {object { sassafras_13_stems texture{ Stem_Texture }} object { sassafras_13_leaves double_illuminate texture{ Leaves_Texture_1 } interior_texture{ Leaves_Texture_2 }} translate<20,0,-56>}
union {object { sassafras_13_stems texture{ Stem_Texture }} object { sassafras_13_leaves double_illuminate texture{ Leaves_Texture_1 } interior_texture{ Leaves_Texture_2 }} translate<40,0,-67>}
union {object { sassafras_13_stems texture{ Stem_Texture }} object { sassafras_13_leaves double_illuminate texture{ Leaves_Texture_1 } interior_texture{ Leaves_Texture_2 }} translate<60,0,-45>}
//Ende Sassafras

//Schwarzeiche
#declare Stem_Texture = 
 texture{ pigment{color rgb 0.9*0.9 } 
	normal { bumps 1.00 scale <0.025,0.075,0.025> }
          finish { phong 0.2 reflection 0.00}         
        } // end of texture 
//-------------------------------------------------------- 
#declare Leaves_Texture_1 = 
 texture{ pigment{ color rgbf< 0.9, 0.9, 0.9, 0.1>*1.0 }   
          normal { bumps 0.15 scale 0.05 }
          finish { phong 1 reflection 0.00}
        } // end of texture 
//-------------------------------------------------------- 
...
union{object{ ca_black_oak_13_stems  texture{ Stem_Texture }} object{ ca_black_oak_13_leaves double_illuminate texture{ Leaves_Texture_1 } interior_texture{ Leaves_Texture_2 }}      scale <2,3,2> translate<80,0,-30>}
union{object{ ca_black_oak_13_stems  texture{ Stem_Texture }} object{ ca_black_oak_13_leaves double_illuminate texture{ Leaves_Texture_1 } interior_texture{ Leaves_Texture_2 }}      scale <2,3,2> translate<0,0,-60>}
//Bodenplatte
object {bodenplatte texture { pigment{ image_map { png "schnee_ground.png" map_type 0 interpolate 2}} rotate <90,0,0> scale 5 finish {ambient 0.8}}}
