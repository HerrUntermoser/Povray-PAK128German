...
texture{T_Wood15 scale 0.5}
 ...
 translate <0,0,-60>}
 //Sandhaufen & Weg================================
 height_field{jpeg "kies_sehrgrob.jpg" smooth scale <15,1,70> translate <25,0,-134> pigment{color Tan*0.8}}
...
union { object { black_oak_2_13_stems texture{Rinde}}
         ...
         scale 5 rotate y*54 translate<90,0,-32>}

 //Bodenplatte
object {bodenplatte texture { pigment{ image_map { jpeg "Boden-Erde-Steine.jpg" map_type 0 interpolate 2}} rotate <90,15,0> scale 20 finish {ambient 0}}}
