...
#declare WandPutz = texture{pigment{cells color_map {[0 color rgb <.72,.92,.64>*.6][.5  color rgb <.47,.62,.42>*.8][1  color rgb <.72,.92,.64>*.6]}} normal { agate .2 agate_turb .8 scale .4 } finish{ambient .1 diffuse .9}}
...
union{
object {Haus translate<-15,0,-130> texture{WandPutz} texture{pigment{image_map{png "zierstreifen_gruen.png"} scale <1,24,1>}}}
object {Haus rotate y*180 translate<95,0,-21> texture{WandPutz} texture{pigment{image_map{png "zierstreifen_gruen.png"} scale <1,24,1>}}}
//Hausnummern
