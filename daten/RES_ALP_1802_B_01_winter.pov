...
//Dachtextur
#declare Dachtextur = texture{pigment{image_map{ png "dachziegel_grau_bump.png" map_type 0 interpolate 2}} normal{bump_map{png "dachziegel_grau_bump.png" map_type 0 interpolate 2 bump_size 2}}scale 4}
...
interior{ media{ method 3
           ...
           density{ spherical // or: boxed
                    ...
                    turbulence 0.95
                    color_map {
                    [0.00 rgbf <0,0,0,0.6>] // density at the border of the media
                    //[0.05 rgbt <0,0,0,0.9>]
                    //[0.20 rgbf <0.2,0.2,0.2,.6>]
                    [0.30 rgbf <0.6,0.6,0.6,.6>]
                    //[0.40 rgbt <1,1,1,0.95>]
                    [1.00 rgbf <1,1,1,0.8>] // densitiy at the center of the media
                               } // end color_map
           } // end of density
...
color_map{[0 color Brown*0.2][1 color rgb 1*0.7]}
}normal {agate 1 scale 1}scale 2}
}
//Blumenbeet rechts
height_field{tga "huegel.tga" smooth scale <10,1.7,10> translate <-13,-0.2,-105> texture{pigment{color rgb 1*0.2}}}
...
//Gruenzeugs dahinter
height_field{png "grass_hf.png" smooth scale <120,0.6,70> translate <-20,0,-85> texture{pigment{gradient x turbulence 0.5 color_map{[0.0 color rgb 1*0.9][0.5 color rgb 1*1.1][1.0 color rgb .7*1]}}}}
//Bäume&Büsche
...
#declare BOZO2 = pigment {
	bozo
	color_map {
		[0 color rgbt<1, 0.9,1,.8>]
		[1 color rgbt<1, 0.98,1,.9>]
	}
	scale 0.04
}
...
#declare Leaves_Texture_1 = 
 texture{ pigment{ color rgbf< .8, 0.8, 0.8, 0.1>*1.0 }   
          normal { bumps 0.15 scale 0.05 }
          finish { phong 1 reflection 0.00}
        } // end of texture 
//-------------------------------------------------------- 
#declare Leaves_Texture_2 = 
 texture{ pigment{ color rgbf< .9, .9, .9, 0.1>*1.0 }   
          normal { bumps 0.15 scale 0.05 }
          finish { phong 0.8 reflection 0.00}
        } // end of texture 
...
//Bodenplatte
object {bodenplatte
texture { pigment{ image_map { png "schnee_ground.png" map_type 0 interpolate 2}} rotate <90,0,0> scale 5 finish {ambient 0}}
}
