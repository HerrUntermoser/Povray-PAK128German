...
object{Haustuer_7_11 translate<16.5,.1,.1>}
//Lampe
prism {
    conic_sweep
    linear_spline
...
object {Haus texture{WandPutz} rotate y*180 translate <20,0,-25>}
object {Haus texture{WandPutz} rotate y*180 translate <60,0,-25>}
object {Haus texture{WandPutz} rotate y*180 translate <100,0,-25>}
...
object{Lampe02_ scale .003 translate <16,0,-133> material{lampe02_mat}}
object{Lampe02_ scale .003 translate <56,0,-133> material{lampe02_mat}}
