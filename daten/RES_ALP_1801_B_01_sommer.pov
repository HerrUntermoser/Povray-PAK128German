...
#declare Roof_Texture1 = texture{
   pigment{gradient x 
           ...
           scale 2 quick_color  Scarlet*1.25}
   normal { bumps 0.8 scale 0.035} 
   finish {phong 0.5}
   translate RoofTrans}
...
//Haustuer
box {<0,0,0>,<7,9,1> rotate y*90 translate <-0.1,0.5,35>}
}
//Ziersockel unten
...
object {Fenster6x6_L2}
difference {box {<-0.4,-0.4,-0.05>,<6.9,6.9,0.05>}box{<0,0,-0.1>,<6.5,6.5,0.1>} pigment{color PaleGreen*0.7}}
 rotate y*180 translate <15,6,-65>}
union{
object {Fenster6x6_L2}
difference {box {<-0.4,-0.4,-0.05>,<6.9,6.9,0.05>}box{<0,0,-0.1>,<6.5,6.5,0.1>} pigment{color PaleGreen*0.7}}
 rotate y*180 translate <30,6,-65>}
union{
object {Fenster6x6_L2}
difference {box {<-0.4,-0.4,-0.05>,<6.9,6.9,0.05>}box{<0,0,-0.1>,<6.5,6.5,0.1>} pigment{color PaleGreen*0.7}}
 rotate y*180 translate <45,6,-65>}
union{
object {Fenster6x6_L2}
difference {box {<-0.4,-0.4,-0.05>,<6.9,6.9,0.05>}box{<0,0,-0.1>,<6.5,6.5,0.1>} pigment{color PaleGreen*0.7}}
 rotate y*180 translate <60,6,-65>}
...
object{ Roof_0 (   45,    // Roof___Angle1, // roof angle                              
                   ...
                   1.3, // R_Cyl,          // radius cylinders
                   1.5,  // Cyl_D,         // distance cylinders
...
box {<-9,-0.1,-80>,<0,0.05,-134> texture{pigment{ crackle scale 1.5 turbulence 0.35
...
#declare BOZO1 = pigment {
	bozo
	color_map {
		[0 color < 0.2, 0.5, 0.0>*0.75]
		[1 color rgb  < 0.2,0.3,0.25 >]
	}
	scale 0.006666667
}
#declare BOZO2 = pigment {
	bozo
	color_map {
		[0 color rgb< 0.2, 0.5, 0.0>]
		[1 color rgb<0.2, 0.5, 0.05>]
	}
	scale 0.006666667
}
...
object {schnee scale <37,6,17> rotate <-34.5,0,0> translate <17,19,-114.3>}
object {schnee scale <49,6,12> rotate <-34.5,0,0> translate <9,19,-114.3>}
object {schnee scale <45,6,12> rotate <34.5,0,0> translate <16,28,-78.9>}
object {schnee scale <40,6,17> rotate <34.5,0,0> translate <16,28,-78.9>}
