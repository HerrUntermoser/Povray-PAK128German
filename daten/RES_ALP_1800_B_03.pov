...
object{Zaun_Pfosten translate <-19.5,0,zLstart>}
#declare zLstart = zLstart + 2;
#end
#declare zRstart = -130;
#declare zRende = -15;
#while (zRstart <= zRende)
object{Zaun_Pfosten translate <99.5,0,zRstart>}
#declare zRstart = zRstart + 2;
#end
#declare xHstart = -20;
#declare xHende = 100;
#while (xHstart <= xHende)
object{Zaun_Pfosten translate <xHstart,0,-14.8>}
#declare xHstart = xHstart + 2;
#end
#declare xVstart =10;
#declare xVende = 100;
#while (xVstart <= xVende)
object{Zaun_Pfosten translate <xVstart,0,-133.8>}
#declare xVstart = xVstart + 2;
#end
...
box {<-19,-0.1,-14>,<99,0.05,-60>texture{ pigment{bozo turbulence 0.3 color_map{[0.0 color rgb < 0.224,  0.106, 0.0 >*0.2]
                                                                [0.5 color rgb < 0.333,  0.149,  0.0 >]
