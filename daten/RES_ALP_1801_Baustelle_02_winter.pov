...
box{<-2,38,-0.4>,<70,38.2,-5> pigment{image_map{jpeg "grasstex_schnee.jpg" map_type 0 interpolate 2}rotate x*90 scale 2}}
...
//Bodenplatte
object {bodenplatte texture { pigment{ image_map {  jpeg "sand_schnee.jpg" map_type 0 interpolate 2}} rotate <90,0,0> scale 40 finish {ambient 0.1}}}
