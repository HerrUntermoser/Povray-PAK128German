...
//===============================================
#declare g_beet = union{difference{box {<0,0,0>,<8,1,18>}box {<0.2,0.5,0.2>,<7.8,1.5,17.8>} texture{T_Wood3 scale 0.4 rotate x*90}}
box {<0.2,0.5,0.2>,<7.8,0.6,17.8>texture{ pigment{image_map{jpeg "Boden-Erde-Steine.jpg" interpolate 2}rotate x*90 scale 5} }}
}
//===========================================================
#declare Haus_Roh =
union{
...
#while (XL <= endx)
difference{
object{Dachziegelengobiert (33) rotate x*50 translate <XL,20.3,-101> texture{pigment{gradient y color_map {[0.0 color White*0.7]
...
#while (XLH <= endxLH)
difference {
object{Dachziegelengobiert (36) rotate x*-50 translate <XLH,18.8,-48> texture{pigment{gradient y color_map {[0.0 color White]
                                                                                                [0.9 color Scarlet*0.5]
                                                                                                [0.9 color rgb 0.1]
                                                                                                [1 color rgb 0]
                                                                                                }
...
#while (ZV <= endZV)
union {
object{Dachziegelengobiert (20) rotate y*90 rotate z*-55 translate <39,30,ZV> texture{pigment{gradient y color_map {[0.0 color White]
                                                                                                [0.9 color Scarlet*0.5]
                                                                                                [0.9 color rgb 0.1]
                                                                                                [1 color rgb 0]
                                                                                                }
...
#while (ZV <= endZV)
object{Dachziegelengobiert (20) rotate y*90 rotate z*55 translate <71.5,30,ZV> texture{pigment{gradient y color_map {[0.0 color White]
                                                                                                [0.9 color Scarlet*0.5]
                                                                                                [0.9 color rgb 0.1]
                                                                                                [1 color rgb 0]
                                                                                                }
...
translate<50,40,-76>}
box{<0,0,0>,<14,.05,35> pigment{image_map{png "dirtwall_snow.png" map_type 0 interpolate 2}rotate x*90 scale <10,1,10>} translate <50,0,-50>}
//===================================
//Holzstoss==========================================
#declare startz = -105;
#declare endz = -80;
...
#declare RINDE = texture {
	pigment {
		...
		color_map {
			...
			[0.35 color rgb <.9, 0.9, 0.9>]
			[0.5 color rgb <0.9, 0.9, 0.9>*2]
			[0.65 color rgb 1]
...
object {bodenplatte texture { pigment{ image_map { png "Boden-Erde-Steine_schnee2.png" map_type 0 interpolate 2} rotate <90,0,0> scale 30} finish {ambient 0}}}
//Ende Bodenplatte
