...
//object {Fenster_AS_6x6 rotate y*90 translate <-0.2,6,43>}
...
object{ Roof_0 (   45,    // Roof___Angle1, // roof angle                              
                   ...
                   0.9, // R_Cyl,          // radius cylinders
                   1.1,  // Cyl_D,         // distance cylinders
...
//Sommer[0.0 T_Wood2][0.7 T_Wood2][0.7 T_Wood15][0.9 BT][1.0 BT]}}}
}
//Gemüsebeete
...
//Mauer======================================================
union{
box { <-20,0,-134>,<-19,7,-15>texture{pigment{ image_map { png "dirtwall_snow.png" map_type 0 interpolate 2} scale 7 rotate y*90}}}
box { <0,0,-134>,<100,7,-133>texture{pigment{ image_map { png "dirtwall_snow.png" map_type 0 interpolate 2} scale 7}}}
box { <99,0,-134>,<100,7,-15>texture{pigment{ image_map { png "dirtwall_snow.png" map_type 0 interpolate 2} scale 7 rotate y*90}}}
box { <-20,0,-14>,<100,7,-15>texture{pigment{ image_map { png "dirtwall_snow.png" map_type 0 interpolate 2} scale 7}}}
}
...
*/
box {<-19.8,-0.1,-15.8>,<0,0.05,-134> pigment{ crackle scale 1.5 turbulence 0.35
...
#declare BOZO1 = pigment {
	bozo
		color_map {
		//[0 color rgb<0.839, 0.576, 0.22>]
		//[1 color rgb<0.839, 0.58, 0.20>]
...
#declare BOZO2 = pigment {
	bozo
	color_map {
		//[0 color rgb<0.769, 0.37, 0.11>]
		//[1 color rgb<0.76, 0.37, 0.12>]
...
//Ende Bodenplatte
//schnee
object {schnee scale <37,6,17> rotate <-34.5,0,0> translate <17,15,-114.3>}
object {schnee scale <49,6,12> rotate <-34.5,0,0> translate <9,15,-114.3>}
object {schnee scale <45,6,12> rotate <34.5,0,0> translate <16,24,-78.9>}
object {schnee scale <40,6,17> rotate <34.5,0,0> translate <16,24,-78.9>}
